...
#define PERFMON_TIMED_MODE_INTERVAL(v)	(PERFMON_BASE(v) + 0x14)
#define PERFMON_TIMED_MODE_ITERATIONS(v)	(PERFMON_BASE(v) + 0x18)
#define PERFMON_DUMP(v)			(VER_CHK6(v) ? 0x67000 : (VER_CHK4(v) ? 0x37000 :\
					VER_CHK(v) ? 0x36010 : 0x031010))
#define PERFMON_STATUS(v)		(VER_CHK6(v) ? 0x67004 : (VER_CHK4(v) ? 0x37004 : VER_CHK(v) ? 0x36014 : 0x031014))

#define LLCC_COUNTER_n_VALUE(v, n)	((VER_CHK6(v) ? 0x67008 : ((VER_CHK4(v) ? 0x37008 :\
					VER_CHK(v) ? 0x36060 : 0x31060))) + 4 * (n))
#define LLCC_COUNTER_n_OVERFLOW(v, n)	((VER_CHK6(v) ? 0x67048 : ((VER_CHK4(v) ? 0x37048 :\
					VER_CHK(v) ? 0x360A0 : 0x310A0))) + 4 * (n))
...
#define ATB_EN_SHIFT			(31)
#define ATB_ATID_SHIFT			(16)
#define MONITOR_EN			BIT(MONITOR_EN_SHIFT)
#define ATB_EN				BIT(ATB_EN_SHIFT)
#define PERFMON_MODE_ATB_EN_MASK	GENMASK(ATB_EN_SHIFT + 0, ATB_EN_SHIFT)
#define PERFMON_MODE_ATB_ATID_MASK	GENMASK(ATB_ATID_SHIFT + 6, ATB_ATID_SHIFT)
