...
/* set LOW_POWER_INIT_PATCH to 1 to initial chip in low power consumption mode
   and supported max cable length will downgrade to 50M */
#define LOW_POWER_INIT_PATCH  0

#if defined(RTK_PHYDRV_IN_LINUX)
  #include "phy_rtl826xb_patch.h"
  #include "construct/conf_rtl8264b.c"
  #if LOW_POWER_INIT_PATCH
    #include "construct/conf_rtl8261n_c_lp.c"
  #else
