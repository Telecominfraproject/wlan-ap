...
#define SMEM_DUAL_BOOTINFO_MAGIC_START_FAILSAFE 0xA3A2A1A2
#define SMEM_DUAL_BOOTINFO_MAGIC_START_TRYMODE_FAILSAFE 0xA3A2A1A3
#define SMEM_DUAL_BOOTINFO_MAGIC_END 0xB3B2B1B0

#define TRYMODE_ENABLED			BIT(0)
#define FAILSAFE_ENABLED		BIT(1)

#define BOOTCONFIG_HEALTH		BIT(13)
#define BOOTCONFIG1_HEALTH		BIT(14)
