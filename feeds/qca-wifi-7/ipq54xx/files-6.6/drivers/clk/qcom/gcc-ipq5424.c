...
static const struct freq_tbl ftbl_gcc_sdcc1_apps_clk_src[] = {
	F(144000, P_XO, 16, 12, 125),
		...
		F(24000000, P_GPLL0_OUT_MAIN, 1, 2, 67),
		F(48000000, P_GPLL0_OUT_MAIN, 1, 2, 33),
		F(96000000, P_GPLL0_OUT_MAIN, 1, 2, 17),
		F(177777778, P_GPLL0_OUT_MAIN, 4.5, 0, 0),
		F(192000000, P_GPLL0_OUT_MAIN, 1, 1, 4),
		F(200000000, P_GPLL0_OUT_MAIN, 4, 0, 0),
	{ }
};
...
static struct clk_rcg2 gcc_q6_axi_clk_src = {
	...
	.freq_tbl = ftbl_gcc_q6_axi_clk_src,
	.clkr.hw.init = &(const struct clk_init_data) {
		.name = "gcc_q6_axi_clk_src",
...
static struct clk_branch gcc_cnoc_wcss_ahb_clk = {
	.halt_reg = 0x310ac,
	.clkr = {
		.enable_reg = 0x310ac,
		.enable_mask = BIT(0),
		.hw.init = &(const struct clk_init_data) {
			.name = "gcc_cnoc_wcss_ahb_clk",
			.parent_hws = (const struct clk_hw *[]) {
				&gcc_wcss_ahb_clk_src.clkr.hw
			},
			.num_parents = 1,
