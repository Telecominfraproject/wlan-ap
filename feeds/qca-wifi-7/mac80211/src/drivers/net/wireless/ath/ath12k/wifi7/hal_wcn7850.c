...
{
	rx_desc_data->msdu_done = ath12k_wifi7_hal_rx_h_msdu_done_wcn7850(ldesc);
	rx_desc_data->msdu_len = ath12k_wifi7_hal_rx_h_msdu_len_wcn7850(ldesc);
	rx_desc_data->l3_pad_bytes = ath12k_wifi7_hal_rx_h_l3pad_wcn7850(ldesc);
	rx_desc_data->is_first_msdu =
		ath12k_wifi7_hal_rx_h_first_msdu_wcn7850(ldesc);
	rx_desc_data->is_last_msdu =
		ath12k_wifi7_hal_rx_h_last_msdu_wcn7850(ldesc);
	rx_desc_data->freq = ath12k_wifi7_hal_rx_h_freq_wcn7850(rx_desc);
	rx_desc_data->pkt_type = ath12k_wifi7_hal_rx_h_pkt_type_wcn7850(rx_desc);
	rx_desc_data->bw = ath12k_wifi7_hal_rx_h_rx_bw_wcn7850(rx_desc);
	rx_desc_data->rate_mcs = ath12k_wifi7_hal_rx_h_rate_mcs_wcn7850(rx_desc);
	rx_desc_data->nss = hweight8(ath12k_wifi7_hal_rx_h_nss_wcn7850(rx_desc));
	rx_desc_data->sgi = ath12k_wifi7_hal_rx_h_sgi_wcn7850(rx_desc);
	...
	rx_desc_data->decap = ath12k_wifi7_hal_rx_h_decap_type_wcn7850(rx_desc);
	rx_desc_data->ip_csum_fail =
		ath12k_wifi7_hal_rx_h_ip_cksum_fail_wcn7850(rx_desc);
	...
	rx_desc_data->seq_ctl_valid =
			ath12k_wifi7_hal_rx_h_seq_ctrl_valid_wcn7850(rx_desc);
	rx_desc_data->fc_valid = ath12k_wifi7_hal_rx_h_fc_valid_wcn7850(rx_desc);
	rx_desc_data->enctype = ath12k_wifi7_hal_rx_h_enctype_wcn7850(rx_desc);
}
...
const struct ath12k_hw_hal_params ath12k_wifi7_hw_hal_params_wcn7850 = {
...
const struct hal_ops hal_wcn7850_ops = {
	.hal_init = ath12k_wifi7_hal_init_wcn7850,
	.create_srng_config = ath12k_wifi7_hal_srng_create_config_wcn7850,
	.rx_desc_set_msdu_len = ath12k_wifi7_hal_rxdesc_set_msdu_len_wcn7850,
	.rx_desc_get_dot11_hdr = ath12k_wifi7_hal_rx_desc_get_dot11_hdr_wcn7850,
	.rx_desc_get_mpdu_frame_ctl =
		ath12k_wifi7_hal_rxdesc_get_mpdu_frame_ctrl_wcn7850,
	.rx_desc_get_crypto_header =
			ath12k_wifi7_hal_rx_desc_get_crypto_header_wcn7850,
	.rx_desc_copy_end_tlv = ath12k_wifi7_hal_rx_desc_end_tlv_copy_wcn7850,
	.rx_desc_get_msdu_src_link_id =
			ath12k_wifi7_hal_rx_get_msdu_src_link_wcn7850,
	.extract_rx_desc_data =
			ath12k_wifi7_hal_extract_rx_desc_data_wcn7850,
	.extract_rx_spd_data =
		ath12k_wifi7_hal_extract_rx_spd_data_wcn7850,
