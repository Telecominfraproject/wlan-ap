...
define Device/arcadyan_mozart
  ...
  DEVICE_PACKAGES := kmod-hwmon-pwmfan kmod-usb3 e2fsprogs f2fsck mkf2fs kmod-mt7996-firmware
...
define Device/edgecore_eap115
  DEVICE_VENDOR := Edgecore
  DEVICE_MODEL := EAP115
  DEVICE_DTS := mt7987a-edgecore-eap115
  DEVICE_DTS_DIR := ../dts
  DEVICE_DTS_OVERLAY := \
	mt7987-spim-nand-eap115 \
	mt7987-netsys-eth0-rtl8211fs \
  ...
  IMAGE/factory.bin := append-ubi | check-size $$$$(IMAGE_SIZE)
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
  DEVICE_PACKAGES := mt798x-2p5g-phy-firmware-internal kmod-mt7996e kmod-mt7990-firmware kmod-usb3 \
		     kmod-mtk-2p5ge-phy kmod-realtek-phy
endef
TARGET_DEVICES += edgecore_eap115

define Device/edgecore_eap115a
  DEVICE_VENDOR := Edgecore
  DEVICE_MODEL := EAP115a
  DEVICE_DTS := mt7987a-edgecore-eap115a
  DEVICE_DTS_DIR := ../dts
  DEVICE_DTS_OVERLAY := \
	mt7987-spim-nand-eap115 \
	mt7987-netsys-eth0-rtl8211fs \
