...
#define NAME_RG_USB20_REV4		"RG_USB20_REV4"
/* #define USB20_PHY_USBPHYACR6	0x18 */
#define SHFT_RG_USB20_REV4		28
#define BV_RG_USB20_REV4		BIT(28)

#define NAME_RG_USB20_SQTH		"RG_USB20_SQTH"
/* #define USB20_PHY_USBPHYACR6	0x18 */
#define SHFT_RG_USB20_SQTH		0
#define BV_RG_USB20_SQTH		GENMASK(3, 0)

#define NAME_RG_USB20_PLL_BW		"RG_USB20_PLL_BW"
#define USB20_PHY_USBPHYACR2		0x08
#define SHFT_RG_USB20_PLL_BW		19
#define BV_RG_USB20_PLL_BW		GENMASK(21, 19)

#define NAME_RG_USB20_BGR_DIV		"RG_USB20_BGR_DIV"
#define USB20_PHY_USBPHYACR0		0x00
#define SHFT_RG_USB20_BGR_DIV		2
#define BV_RG_USB20_BGR_DIV		GENMASK(3, 2)
...
#define force_preemphasis_disabled(...)
const char *xhci_mtk_decode_portsc(char *str, u32 portsc)
{
		return NULL;
}
