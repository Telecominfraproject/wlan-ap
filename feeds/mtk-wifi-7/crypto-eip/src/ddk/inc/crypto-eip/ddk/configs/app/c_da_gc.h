...
#ifndef DEMOAPP_GLOBAL_CS_IV
// Four words to provide IVs
#define DEMOAPP_GLOBAL_CS_IV  {0x28e1d20f, 0x30507ca5, 0x084484f1, 0xb8a5aeab}
#endif

#ifndef DEMOAPP_GLOBAL_NOF_CES
#define DEMOAPP_GLOBAL_NOF_CES           1
#endif
