...
hostapd_common_add_device_config() {
	...
	config_add_boolean multiple_bssid rnr_beacon co_locate ema_beacon
...
hostapd_prepare_device_config() {
	...
	json_get_vars country country_ie beacon_int:100 dtim_period:2 doth require_mode legacy_rates \
		...
		multiple_bssid co_locate rnr_beacon ema_beacon
	...
	[ "$ema_beacon" -gt 0 ] && append base_cfg "ema_beacon=$ema_beacon" "$N"
	[ "$co_locate" -gt 0 ] && append base_cfg "co_locate=$co_locate" "$N"
