...
#define wlog(...) wc_put_logline( (APP_LOG_WEBSOCK | DEBUG_LEVEL_1), __VA_ARGS__ )
#define wdbg1(...) wc_put_logline( (APP_LOG_WEBSOCK | DEBUG_LEVEL_2), __VA_ARGS__ )
#define wdbg2(...) wc_put_logline( (APP_LOG_WEBSOCK | DEBUG_LEVEL_3), __VA_ARGS__ )
#define wdbg3(...) wc_put_logline( (APP_LOG_WEBSOCK | DEBUG_LEVEL_4), __VA_ARGS__ )
...
LWS_EXTERN void a2w_logfr_and_reboot( char * Buf );
#ifdef __cplusplus
};
#endif
